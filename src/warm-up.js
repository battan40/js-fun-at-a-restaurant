...
if (isFavorite === true){
  ...
  console.log(`I recently ate ${food}, so I'm not interested.`)
}
//------------------------- Arrays -------------------------//
...
var vegetables = ['beets', 'celery', 'spinach', 'tomatos', 'peppers'];
// Write the code to access the 3rd element of the Array, using bracket
// notation.
vegetables[2];
// Create a new variable "fruits" and assign it to an Array of 7
// different fruits.
var fruits = ['kiwi', 'piña', 'strawberry', 'lime', 'pomogranite', 'mango', 'grapes']
